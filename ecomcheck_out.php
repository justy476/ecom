...
// This page would come after the billing process.
 ...
 // Assume that the customer is logged in and that this page has access to thecustomer’s ID:
$customer = 1; // Temporary.

 // Assume that this page receives the order total.
 $total = 178.93; // Temporary.

 require_once ('../../ecommysqli_connect.php'); // Connect to the database.
...
You will be notified when shipment of item(s)
begins.</p>';
