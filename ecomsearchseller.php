<?php # Script 17.5 - ecombrowse_items.php
 ...
 if (isset($_POST['submit-search'] )){
    ...
    $q = "SELECT sellers.seller_id, CONCAT_WS(' ', first_name, middle_name, last_name) AS seller FROM sellers WHERE first_name='$search' OR middle_name ='$search' OR last_name = '$search' ORDER BY sellers.last_name ASC";  
